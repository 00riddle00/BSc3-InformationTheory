...
if mode == 'e': # FILE ENCODING
    ...
    dicLengthBitStr = bin(len(dic)) # then we write the number of encoding tuples
    ...
    if tailLength > 0:
        ...
        # print tail
    n = int(bitReader(parameter), 2) # then read the number of encoding tuples
