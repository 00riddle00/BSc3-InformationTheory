...
00010000 00100010 11110110 10000000 00000110

00010 000    | 0     0              1               00                0                1               0|1               1                11                 0110 | 10    000000            | 00000110
00010 000    | 0     0              1              "00"               0                1              "0|1"              1               "11"                0110 | 10    000000            | 00000110
k=2   tail_len=0   | v1 vertex is | v1.left.child | v1.left.child's | v1.right.child | v2.left.child | v2.left.child's | v2.right.child | v2.right.child's |             | six trailing     | last byte to hold nullTail len (=6 =110)
                   | not a leaf   | is a leaf     | value           | is not a leaf  | is a leaf     | value           | is a leaf      | value            |             | zeroes (nullTail | ant its zero padding (5 leading zeroes)
                   |                                                |                |                                 |                |                  |             | len = 6)
                   |                                                | (end of v1)    |                                 | (end of v2)    |                  |            
